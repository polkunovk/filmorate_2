...
public class FilmDbStorage extends BaseStorage<Film> implements FilmStorage {
    ...
    private static final String SELECT_BY_NAME_QUERY = "SELECT * FROM FILM WHERE NAME = ?";
    private static final String INSERT_FILM_QUERY = "INSERT INTO FILM(NAME, DESCRIPTION, RELEASE_DATE, DURATION, MPA_ID)" +
            "VALUES (?, ?, ?, ?, ?)";
    private static final String UPDATE_FILM_QUERY = "UPDATE FILM SET NAME = ?, DESCRIPTION = ?, DURATION = ?, MPA_ID = ?," +
    ...
    public Optional<Film> findByName(String name) {
        return findOne(SELECT_BY_NAME_QUERY, name);
    }
